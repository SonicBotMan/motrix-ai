...
function mockAria2(overrides: Partial<Aria2Client> = {}): Aria2Client {
  return {
    ...
    tellActive: vi.fn().mockResolvedValue([
      { gid: 'g1', status: 'active', totalLength: '100', completedLength: '50', downloadSpeed: '10', uploadSpeed: '5', files: [] },
    ]),
    tellWaiting: vi.fn().mockResolvedValue([
      { gid: 'g2', status: 'waiting', totalLength: '200', completedLength: '0', downloadSpeed: '0', uploadSpeed: '0', files: [] },
    ]),
    tellStopped: vi.fn().mockResolvedValue([
      { gid: 'g3', status: 'complete', totalLength: '300', completedLength: '300', downloadSpeed: '0', uploadSpeed: '0', files: [] },
    ]),
